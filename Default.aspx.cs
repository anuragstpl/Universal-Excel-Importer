...
public partial class _Default : Page
{
    ...
    {
        drpTables.DataSource = msSqlHelper.GetDBTables(txtConnectionString.Text);
    ...
    {
        Session["ColumnNames"] = msSqlHelper.GetTableColumns(txtConnectionString.Text, drpTables.SelectedItem.Text);
